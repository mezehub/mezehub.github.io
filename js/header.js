{
	...
	const elClipsVideo = /** @type {HTMLVideoElement} */ (document.getElementById("front-clips-video"));
	const elClipsCanvas = document.createElement("canvas");
	elClipsCanvas.id = "front-clips-canvas";
	...
	function animCanvas() {
		...
		ctx2d.drawImage(elClipsVideo, ctxW / 2 - w / 2, ctxH / 2 - h / 2, w, h);
